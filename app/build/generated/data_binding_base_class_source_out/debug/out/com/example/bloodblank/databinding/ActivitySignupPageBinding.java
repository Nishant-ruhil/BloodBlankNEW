...
public final class ActivitySignupPageBinding implements ViewBinding {
  ...
  private ActivitySignupPageBinding(@NonNull RelativeLayout rootView, @NonNull LinearLayout divider,
  ...
  public static ActivitySignupPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignupPageBinding((RelativeLayout) rootView, divider, email, loginButton,
